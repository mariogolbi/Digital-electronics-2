 ...
 * @note  F_CPU = 16 MHz
 *
 * we can see there is a different time of foverflow, because of the equation that return this, it depends on the bits
 * and also the data value of those bits
 *
 */
...
/** @brief Stop timer, prescaler 000 --> STOP */
#define TIM0_stop()           TCCR0B &= ~((1<<CS02) | (1<<CS10) | (1<<CS10));
